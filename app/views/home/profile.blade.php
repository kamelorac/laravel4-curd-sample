...
{{ Form::open(array('url' => '#', 'id' => 'frmRegister')) }}
	...
	<div class="form-group">
      ...
      <div class="checkbox">
        ...
        <label>
        	{{ Form::checkbox('status1', '1') }} Artist, Performer <br/>
        	{{ Form::checkbox('status1', '1') }} Record label, Publisher, Producer, Manager <br/>
        	{{ Form::checkbox('status1', '1') }} Collecting company <br/>
        	{{ Form::checkbox('status1', '1') }} Broadcaster <br/>
